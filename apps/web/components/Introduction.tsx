...
export function Introduction({
  ...
  return (
    <div className="font-[family-name:var(--font-roboto-mono)] min-h-[calc(100vh-12px)] bg-bg px-6 pb-12 pt-[70px] shadow-[0px_4px_10px_rgba(0,0,0,0.04)] sm:px-10 lg:px-12 xl:px-20 2xl:px-[120px]">
